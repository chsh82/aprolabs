...
### 띄어쓰기 교정 (매우 중요)
1. 전각 공백(　)을 모두 반각 공백으로 변환
2. 연속 공백(2개 이상)을 단일 공백으로 축소
3. 붙어있는 단어를 한국어 맞춤법에 맞게 띄어쓰기
   - 조사는 앞 단어에 붙임: "것은", "하는데", "에서는"
   - 의존명사는 띄어쓰기: "것 같다", "수 있다", "바 있다", "뿐만 아니라"
   - 단위명사는 앞 숫자에 붙임: "3개", "10%", "2배" (숫자+단위 사이 공백 제거)
   - 보조용언은 띄어쓰기: "해 보다", "먹어 버리다" (단, "~아/어" 뒤)
4. PDF 원본의 줄바꿈 위치에서 단어가 잘려 띄어쓰기가 생긴 경우 복원
   - 예: "살펴보고 있 다." → "살펴보고 있다."
   - 예: "적절하지 않 은 것은?" → "적절하지 않은 것은?"
   - 예: "가능성이 더 높 다." → "가능성이 더 높다."
5. 선택지(①②③④⑤) 앞뒤 공백 정리
   - 선택지 번호 뒤에 공백 1개: "① 블록체인의..."
   - 선택지 번호와 내용 사이 과도한 공백 제거

### 기타 필수 교정
6. 밑줄: PDF에서 밑줄이 그어진 단어/구절을 <u>텍스트</u>로 표시
7. 특수문자: ㉠㉡㉢, ⓐⓑⓒ, ①②③ 등 원문자 정확히 복원
8. 오탈자: PDF 원본과 다른 글자 교정

### 줄바꿈 교정 (매우 중요)
9. 대화체 줄바꿈: 화자가 바뀔 때 반드시 줄바꿈 삽입
   - 예: "습니다. 사회자:" → "습니다.\n사회자:"
   - 예: "합니다. 찬성 1:" → "합니다.\n찬성 1:"
   - 예: "입니다. 면장:" → "입니다.\n면장:"
10. 발표문 지시문: "(자료를 제시하며)", "(화면을 가리키며)" 등 앞에 줄바꿈
    - 예: "습니다. (자료를 제시하며)" → "습니다.\n(자료를 제시하며)"
11. 문단 나누기: PDF 원본의 문단 구조를 정확히 반영
...
12. 시(詩)의 행 구분: 각 행을 줄바꿈으로 분리, 연(聯) 사이는 빈 줄
